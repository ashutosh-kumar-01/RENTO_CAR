...
const CarDetails = () => {
  ...
  return car ? (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-10 pb-20 bg-black min-h-screen">
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 mb-8 text-gray-500 hover:text-amber-500 transition-colors cursor-pointer font-medium group"
      >
          ...
          <div className="bg-zinc-900 rounded-2xl p-8 shadow-2xl shadow-black/50 border border-white/5 space-y-8">
            <div>
              ...
              <div className="flex items-center gap-3 mt-3">
                <span className="px-4 py-1.5 bg-amber-500/10 text-amber-500 text-sm font-bold rounded-full uppercase tracking-wider border border-amber-500/20">{car.category}</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                <div
                  key={text}
                  className="flex flex-col items-center justify-center bg-white/5 p-5 rounded-xl border border-white/5 hover:border-amber-500/30 transition-all group"
                >
        ...
        <div className="relative">
            ...
            <div className="space-y-4">
                <div className="flex flex-col gap-2">
                    ...
                    <input
                    type="date"
                    className="bg-white/5 border border-white/10 text-white px-4 py-3 rounded-xl focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500/50 outline-none transition-all w-full"
                    required
                    id="pickup-date"
            ...
            <button className="w-full bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 active:scale-95 transition-all py-4 font-bold text-black rounded-xl cursor-pointer shadow-lg shadow-amber-900/30 uppercase tracking-wider">
                Book Now
            </button>
