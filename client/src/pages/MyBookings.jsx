    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-10 pb-20 text-sm max-w-7xl mx-auto min-h-screen'>
      <div className="animate-fade-in-up mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        {bookings.length > 0 && (
          <button
            ...
            disabled={isClearing}
            className="group flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-gray-500/20 to-gray-400/10 border border-gray-400/30 rounded-xl text-gray-300 hover:from-gray-500/30 hover:to-gray-400/20 hover:border-gray-400/50 hover:text-red-300 transition-all duration-300 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-gray-400/10 hover:shadow-gray-400/20"
          >
            {isClearing ? (
              <>
      ...
      <div className="space-y-6">
        {bookings.length === 0 ? (
            ...
            <div key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-slate-800 rounded-xl bg-slate-900 shadow-lg shadow-black/50 hover:shadow-gray-400/10 transition-all animate-fade-in' style={{animationDelay: `${index * 100}ms`}}>
                {/* Car image and info */}
                ...
                <p className='text-gray-400 text-xs mt-1 uppercase tracking-wide'>{booking.car?.year} • {booking.car?.category} • {booking.car?.location}</p>
                    ...
                    <div className='md:col-span-2 flex flex-col justify-center space-y-4'>
                        ...
                        <span className={`px-3 py-1 text-xs font-semibold rounded-full uppercase tracking-wide ${booking.status === 'confirmed' ? 'bg-green-900/30 text-gray-300 border border-gray-400/30' : 'bg-red-900/30 text-gray-300 border border-gray-400/30'}`}>{booking.status}</span>
                    ...
                    <div className='md:col-span-1 flex flex-col justify-center items-end gap-2 border-t md:border-t-0 md:border-l border-slate-800 pt-4 md:pt-0 md:pl-6'>
                        ...
                        <h1 className='text-3xl font-bold text-gray-300'>{currency}{booking.price}</h1>
                        ...
                        <div className="mt-4 w-full space-y-2">
                            ...
                            {booking.status !== 'cancelled' && (
                                <button 
                                    ...
                                    className="w-full py-2 border border-gray-400/30 bg-gray-400/10 rounded-lg text-gray-300 hover:bg-gray-400/20 hover:border-gray-400/50 transition-colors text-xs font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-xl border border-slate-700">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-200">{currency}{selectedBooking.price}</p>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  {selectedBooking.status !== 'cancelled' && (
                    <button
                      ...
                      className="flex-1 py-3 bg-gray-400/20 border border-gray-400/30 rounded-xl text-gray-300 hover:bg-gray-400/30 transition-colors font-medium flex items-center justify-center gap-2"
                    >
