  ...
  return (
    <div className='flex items-center justify-between px-6 md:px-10 py-4 text-gray-300 border-b border-slate-800 bg-black relative transition-all'>
        <Link to='/' className="group flex items-center gap-2">
            {/* Logo Icon */}
            <div className="w-9 h-9 bg-gradient-to-br from-gray-200 to-gray-400 rounded-lg flex items-center justify-center shadow-lg shadow-white/20">
            ...
            <div className="flex items-center">
                ...
                <span className="text-xl font-bold text-white group-hover:text-gray-200 transition-colors">Car</span>
            </div>
        </Link>
        <div className="flex items-center gap-3">
            <div className={`h-2 w-2 rounded-full animate-pulse ${user ? 'bg-emerald-500' : 'bg-red-500'}`}></div>
