...
const LuxuryFleet = () => {
  ...
  return (
    <div ref={sectionRef} className="bg-black py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 overflow-hidden relative min-h-screen">
      ...
      <div className="absolute top-20 right-10 md:right-20 w-48 md:w-96 h-48 md:h-96 bg-white/5 rounded-full blur-[100px] md:blur-[150px] pointer-events-none"></div>
      <div className="absolute bottom-20 left-10 md:left-20 w-40 md:w-80 h-40 md:h-80 bg-gray-400/5 rounded-full blur-[80px] md:blur-[120px] pointer-events-none"></div>
      ...
      >
        <span className="text-white text-[10px] sm:text-xs font-medium tracking-[0.3em] sm:tracking-[0.4em] uppercase mb-3 sm:mb-4 block">Premium Collection</span>
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white tracking-tight">
          TOP <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-300">10</span> LUXURY CARS
        </h2>
        ...
        <div className="flex-1 space-y-6 sm:space-y-8 text-center lg:text-left">
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6 justify-center lg:justify-start">
              <span className="text-5xl sm:text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-gray-200 to-gray-300/20">
                {String(activeCarIndex + 1).padStart(2, '0')}
              </span>
              <div className="w-12 sm:w-16 md:w-20 h-[2px] bg-gradient-to-r from-white to-transparent"></div>
            </div>
          ...
          >
            ...
            <div className="flex flex-col items-center lg:items-start">
              ...
              <span className="text-lg sm:text-xl md:text-2xl text-white font-bold">${activeCar.price}</span>
            </div>
          </motion.div>
          ...
          <motion.button
            ...
            className="px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 bg-gradient-to-r from-white to-gray-400 text-black font-bold rounded-full hover:from-gray-200 hover:to-gray-300 transition-all flex items-center gap-2 sm:gap-3 md:gap-4 mx-auto lg:mx-0 shadow-lg shadow-amber-900/30 text-sm sm:text-base"
          >
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center lg:justify-end lg:pr-10 pointer-events-none">
            <div className="relative w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px]">
              ...
              <div className="absolute -inset-8 sm:-inset-12 border border-white/10 rounded-full opacity-30"></div>
              <div className="absolute inset-8 sm:inset-12 bg-white/5 rounded-full blur-3xl"></div>
            </div>
          </div>
            ...
            <motion.div 
              ...
              className={`min-w-[160px] sm:min-w-[180px] md:min-w-[220px] w-[160px] sm:w-[180px] md:w-[220px] p-3 sm:p-4 rounded-xl sm:rounded-2xl cursor-pointer transition-all duration-300 border relative overflow-hidden group flex flex-col ${
                index === activeCarIndex 
                  ? 'bg-gradient-to-br from-white/20 to-gray-400/10 border-white/50 shadow-lg shadow-white/20' 
                  : 'bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20'
              }`}
            >
              {/* Rank number */}
              <p className={`text-[10px] sm:text-xs font-black mb-1 sm:mb-2 ${index === activeCarIndex ? 'text-gray-200' : 'text-gray-600'}`}>
              ...
              <p className={`text-[10px] sm:text-xs truncate ${index === activeCarIndex ? 'text-gray-200' : 'text-gray-600'}`}>
              ...
              {index === activeCarIndex && (
                <motion.div 
                  ...
                  className="absolute bottom-0 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r from-white to-gray-400"
                />
              )}
            </motion.div>
          ))}
